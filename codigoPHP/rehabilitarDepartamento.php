...
if(isset($_REQUEST['cancelar'])){//si el usuario ha pulsado el boton cancelar
    header('Location: mtoDepartamentos.php');//Redirigimos al usuario a la ventana de mtoDepartamentos
}
...
try {
        ...
        $parametros = [":CodDepartamento" => $_SESSION['CodDepartamento']];
    ...
    if(isset($_REQUEST['aceptar'])){//Si pulsa el botón de aceptar
        try{
            ...
            $sqlBaja = "UPDATE T02_Departamento set T02_FechaBajaDepartamento=NULL where T02_CodDepartamento=:CodDepartamento";
