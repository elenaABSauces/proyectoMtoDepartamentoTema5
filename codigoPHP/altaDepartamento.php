...
if(isset($_REQUEST['cancelar'])){//Si pulsa el botón de cancelar
    ...
    if(isset($_REQUEST['aceptar'])){ //Comprobamos que el usuario haya enviado el formulario
        ...
        try{//Comprobamos que el codigo de departamento no se encuentre en la base de datos
            ...
            $sqlCod = "SELECT T02_CodDepartamento from T02_Departamento where T02_CodDepartamento='{$_REQUEST['CodDepartamento']}'";
        ...
        try {
            ...
            $sql = <<<EOD
               INSERT INTO T02_Departamento (T02_CodDepartamento, T02_DescDepartamento, T02_FechaCreacionDepartamento, T02_VolumenNegocio) VALUES 
                    (:CodDepartamento, :DescDepartamento,:FechaCreacionDepartamento, :VolumenNegocio); 
EOD;
